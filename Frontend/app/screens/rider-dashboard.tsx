...
//             style={{
//               backgroundColor: expandedInstructions === order.id ? '#8B5CF6' : '#EC4899',
//               shadowColor: expandedInstructions === order.id ? '#8B5CF6' : '#EC4899',
...
//                   {order.instructionSteps.length} step guide
//                 </Text>
//               </View>
//             </View>
//             <Animated.View
...
//                 {order.instructionSteps.map((_, index) => {
...
//                           ? order.instructionSteps && order.instructionSteps[currentStep]
//                             ? order.instructionSteps[currentStep].color
//                             : '#D1D5DB'
//                           : '#D1D5DB',
//                       }}
//                     />
...
//                         },
//                         {
//                           translateY: getStoryAnim(order.id, index).interpolate({
//                             inputRange: [0, 1],
//                             outputRange: [50, 0],
//                           })
//                         }
...
//                               Step {index + 1}/{order.instructionSteps?.length ?? 0}
//                             </Text>
//                           </View>
//                         </View>
//                         <Text 
...
//                           className="flex-1 bg-white rounded-xl py-3 flex-row items-center justify-center border-2"
//                           style={{ borderColor: step.color }}
//                         >
//                           <Ionicons name="chevron-back" size={20} style={{ color: step.color }} />
//                           <Text className="font-semibold ml-1" style={{ color: step.color }}>
//                             Previous
//                           </Text>
//                         </TouchableOpacity>
//                       )}
